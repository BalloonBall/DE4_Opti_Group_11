...
lb = [1 1 1 1]; 
ub = [37 37 37 37]; %upper bound is number of materials
%GA will pick integers between 1 and 37 for each material property.
%These integers correspond to indices of the discrete material properties

%% Run GA with cost (objective) function 'CO2All'
...
[xbestDisc, fbestDisc, exitflagDisc] = ga(@CO2All, ...
    4, [], [], [], [], lb, ub, [], 1:4, opts); %since our constraints are inherent to the dataset, not are set here

%% Displaying Results

fprintf('\nOptimal Sustainability of hypothetical composite using ANY foam in CES = %g kg CO2 equivalent.\n', fbestDisc);
